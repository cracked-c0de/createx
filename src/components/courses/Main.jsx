                ...
                <div className="flex flex-col text-[#1E212C]">
                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex items-center justify-between gap-7 font-[700]">
                            <p onClick={() => updActive(0)} className={`text-[14px] py-2 px-4 cursor-pointer rounded ${active == 0 ? "text-[#FF3F3A] border border-[#FF3F3A] " : "text-[#9A9CA5] border border-white/0 hover:border-[#9A9CA5]"}`}>All <sup className="text-[10px] font-[900] group-hover:text-[#FF3F3A]">{courses.length}</sup></p>
                            <p onClick={() => updActive(1)} className={`text-[14px] py-2 px-4 cursor-pointer rounded ${active == 1 ? "text-[#FF3F3A] border border-[#FF3F3A] " : "text-[#9A9CA5] border border-white/0 hover:border-[#9A9CA5]"}`}>Marketing <sup>{marketing.length}</sup></p>
                            <p onClick={() => updActive(2)} className={`text-[14px] py-2 px-4 cursor-pointer rounded ${active == 2 ? "text-[#FF3F3A] border border-[#FF3F3A] " : "text-[#9A9CA5] border border-white/0 hover:border-[#9A9CA5]"}`}>Management <sup>{management.length}</sup></p>
                            <p onClick={() => updActive(3)} className={`text-[14px] py-2 px-4 cursor-pointer rounded ${active == 3 ? "text-[#FF3F3A] border border-[#FF3F3A] " : "text-[#9A9CA5] border border-white/0 hover:border-[#9A9CA5]"}`}>HR & Recruiting <sup>{hr.length}</sup></p>
                            <p onClick={() => updActive(4)} className={`text-[14px] py-2 px-4 cursor-pointer rounded ${active == 4 ? "text-[#FF3F3A] border border-[#FF3F3A] " : "text-[#9A9CA5] border border-white/0 hover:border-[#9A9CA5]"}`}>Design <sup>{design.length}</sup></p>
                            <p onClick={() => updActive(5)} className={`text-[14px] py-2 px-4 cursor-pointer rounded ${active == 5 ? "text-[#FF3F3A] border border-[#FF3F3A] " : "text-[#9A9CA5] border border-white/0 hover:border-[#9A9CA5]"}`}>Development <sup>{development.length}</sup></p>
                        </div>
